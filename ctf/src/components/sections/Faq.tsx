...
const faqData = [
  ...
  {
    question: '팀으로 참가할 수 있나요?',
    answer: '본 대회는 개인 참가만 가능합니다. 단, 사전교육 과정에서는 멘토의 지도하에 팀 활동이 있을 수 있습니다.'
  },
  {
  ...
  },
  {
    ...
    answer: '네, 사전교육은 대회 참가를 위한 필수 과정입니다. 오프라인 교육(7월 7일)에는 반드시 참석해야 하며, 온라인 교육 자료도 학습하셔야 합니다.'
  },
  {
    question: '대회 참가 신청 후 취소할 수 있나요?',
    answer: '네, 참가 신청 후 취소가 가능합니다. 다만, 취소 시 반드시 주최측에 연락하여 취소 의사를 알려주셔야 합니다. 신청 후 불참 시 다음 대회 참가에 제한이 있을 수 있습니다.'
  },
  {
