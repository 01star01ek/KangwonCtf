...
const faqData = [
  ...
  },
  {
    ...
    answer: '네, 기초적인 컴퓨터 활용 능력만 있다면 누구나 참가 가능합니다.\n사전교육을 통해 기본적인 내용부터 차근차근 배울 수 있습니다.'
  },
  {
    question: '대회에 필요한 장비를 제공해 주나요?',
    answer: '대회장에는 기본적인 컴퓨터가 준비되어 있습니다.\n그러나 본인이 익숙한 노트북을 가져오셔도 됩니다.'
  },
  {
    question: '사전교육에 반드시 참석해야 하나요?',
    answer: '네. 사전 교육은 대회 참가를 위한 필수 과정입니다.\n다만, 오프라인 교육(7월 7일)에 참석이 어려우실 경우 운영진에게 미리 연락 주시면 온라인으로 참석할 수 있도록 안내 드리겠습니다.'
  },
  {
    question: '대회 참가 신청 후 취소할 수 있나요?',
    answer: '네, 본 대회에 참여 의사가 없으신 경우, 선발 되기 전까지 취소가 가능합니다.\n취소 시 반드시 주최측에 연락하여 취소 의사를 알려주셔야 합니다.\n선발 후 불참 시 다음 대회 참가에 제한이 있을 수 있습니다.'
  },
  {
    question: '중학생과 고등학생이 함께 경쟁하나요?',
    answer: '네, 중학생과 고등학생이 함께 경쟁합니다.\n다만, 문제는 다양한 난이도로 구성되어 있어 중학생도 충분히 도전할 수 있습니다.\n또한, 평가 시 학년을 고려하여 가산점이 부여될 수 있습니다.'
  }
];
